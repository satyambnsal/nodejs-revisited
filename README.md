...
Purpose of this project is to revisit NodeJS concepts as its been a time since I've created a NodeJS app from scratch. 

For this project, I'm using Frontend master's node-hard-part course code as base code and then modify it.
